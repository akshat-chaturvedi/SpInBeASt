...
scatter1 = ax.scatter(t_p, l_p, marker="o", s=300, zorder=2, c=m_p, cmap=cm.managua, edgecolors="k", linewidth=2)
scatter2 = ax.scatter(t_c, l_c, marker="o", s=300, zorder=2, c=m_p, cmap=cm.managua, edgecolors="k", linewidth=2)
